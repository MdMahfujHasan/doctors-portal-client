        ...
        <div>
            ...
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box">
                    ...
                    <h3 className="font-bold text-lg text-secondary"><span className='text-indigo-600'>Booking for</span> {name}</h3>
                    <form onSubmit={handleBooking} className='grid grid-cols-1 gap-3 justify-items-center mt-3'>
                        ...
                        <input type="text" name="phone" minLength="11" placeholder="Phone Number" required className="input input-bordered w-full max-w-xs" />
